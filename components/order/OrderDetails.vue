                    ...
                    <v-list dense shaped class="mt-n5">
                        ...
                        <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                            <v-list-item-title>
                                ...
                                <span class="teal--text text-caption font-weight-bold mr-2 ml-7">Posted by:</span> <span class="text-caption font-weight-bold grey--text" style="color: #636a6c">
                                {{ order.owner_name }}
                                </span>
                            </v-list-item-title>
                        </v-list-item>
                        ...
                        <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                            <v-list-item-title>  
                                ...
                                <span class="teal--text text-caption font-weight-bold mr-2 ml-7">Posted on:</span> <span class="text-caption font-weight-bold grey--text" style="color: #636a6c">
                        ...
                        <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                            <v-list-item-title >
                                ...
                                <span class="teal--text text-caption font-weight-bold mr-2 ml-7">Order Category:</span> <span class="text-caption font-weight-bold grey--text" style="color: #636a6c">
                                {{ order.category }}
                                </span>
                            </v-list-item-title>
                        </v-list-item>
                        ...
                        <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                            <v-list-item-title>
                                ...
                                <span class="teal--text text-caption font-weight-bold mr-2 ml-7">Order Specialty:</span> <span class="text-caption font-weight-bold grey--text" style="color: #636a6c">
                                {{ order.specialty }}
                                </span>
                            </v-list-item-title>
                        </v-list-item>
                        ...
                        <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                            <v-list-item-title>  
                                <v-icon x-small color="grey" class="mr-n5 ml-5">mdi-calendar</v-icon>
                                <span class="teal--text text-caption font-weight-bold mr-2 ml-7">Acceptable Payble Range:</span> <span class="text-caption font-weight-bold grey--text" >
