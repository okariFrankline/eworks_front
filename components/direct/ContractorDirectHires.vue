            ...
            <v-card class="mx-auto" width="535" elevation="2" >
                <v-card-title class="ml-2">
                    <v-row justify="center" class="mb-n2">
                        <v-icon small left color="teal" class="ml-2">mdi-account-arrow-right</v-icon>
                        <span class="text-caption font-weight-bold teal--text text-capitalize">
                            My Direct Hire Requests
                        </span>
                        <v-spacer></v-spacer>
                                ...
                                <v-row class="mt-n3 ml-n3">
                                    <v-menu open-on-hover offset-y>
                                        ...
                                        <v-list dense shaped>
                                            ...
                                            <v-list-item dense color="purple darken-3" class="text--red mb-n2">
                                                <v-list-item-title> 
                                                    <span class="teal--text text-caption font-weight-bold mr-2">Accept order before:</span> <span class="text-caption font-weight-bold" style="color: #636a6c">
                                    ...
                                    <div class="mr-4">
                                        <span class="text-caption font-weight-bold warning--text">
                                            {{ request.is_accepted ? 'Accepted' : 'Active' }}
                                        </span>
                                    </div>
                                </v-row>
                            </v-card-title>
